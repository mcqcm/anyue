            ...
            columnDefs: [
                {//列添加函数
                    ...
                    render: function (a, b, c, d) {
                        ...
                        {
                            func: [
                                   //{"name": "添加货物", "fn": "mod(\'" + "ingoods/addgoods.jsp" + "\',\'" + c.id + "\',\'" + "添加货物" + "\')", "type": "primary"},
                                   {"name": "修改供应商", "fn": "mod(\'" + "ingoods!modIngoods.action" + "\',\'" + c.id + "\',\'" + "修改供应商" + "\')", "type": "primary"},
                                   {"name": "资质证明", "fn": "see(\'" + "ingoods!seeProve.action" + "\',\'" + c.id + "\',\'" + "查看资质证明" + "\')", "type": "primary"},
                                   {"name": "进货详单", "fn": "seeBig(\'" + "ingoods!seeInGoods.action" + "\',\'" + c.id + "\',\'" + "进货详情" + "\')", "type": "primary"},
                                   {"name": "删除", "fn": "del(\'" + "ingoods!delInGoods.action" + "\',\'" + c.id + "\')", "type": "danger"}
                            ]
                        };
