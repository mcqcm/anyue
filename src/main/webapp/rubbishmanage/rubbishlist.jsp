...
//**************************************************************************************************************
            ...
            columnDefs: [
                {//列添加函数
                    ...
                    render: function (a, b, c, d) {
                        ...
                        {
                            func: [
                                   {"name": "查看修改处理详情", "fn": "mod(\'" + "rubbish!seeContent.action" + "\',\'" + c.id + "\',\'" + "查看处理详情" + "\')", "type": "primary"},
                                   {"name": "删除", "fn": "del(\'" + "rubbish!del.action" + "\',\'" + c.id + "\')", "type": "danger"}
                            ]
                        };
            ...
            initComplete: function () {
                $("#mytool").append('<button type="button" class="btn btn-default btn-sm" onclick="add(\'rubbishmanage/addrubbish.jsp\',\'添加废物处理\')">添加废物处理</button>');
                datesearch();
            }
...
<div class="container" style="position: relative;  height:95%; width:100%;">
	...
	<a class="toggle-vis" data-column="3">处理简介</a>&nbsp;
	<a class="toggle-vis" data-column="4">处理时间</a>&nbsp;
	<a class="toggle-vis" data-column="5">处理数量</a>&nbsp;
