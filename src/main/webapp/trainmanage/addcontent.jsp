...
<form name="form1" id="form1" action="trainmanage!saveorupdatecontent.action" target="traincontent" method="post">
		...
		<tr>
			<td>标题：</td><td><input type="text" name="trainContent.tittle"/></td>
		</tr>
		<tr>
			<td>发布时间：</td><td><input type="text"  name="trainContent.publishtime" value="<%=date%>" readonly="readonly"/></td>
		</tr>
		<tr>
			<td>内容：</td><td><textarea id="notice" name="trainContent.content" cols="20" rows="2" ></textarea>
			</td>
		</tr>		
		<tr>
			<td></td><td><input type="hidden" name="trainContent.uporend" value="no"/></td>
		</tr>
		<tr>
			<td colspan="2">
