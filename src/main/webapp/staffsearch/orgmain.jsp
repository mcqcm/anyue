		...
		<td id="hideCon" class="ver01 ali01">
							<div id="lbox">
								...
								<div id="lbox_middleright">
										<div id="bs_left">
										<IFRAME scrolling="no" width="100%" height="100%"  frameBorder=0 id=allstaffleft name=allstaffleft src="/anyue/staffsearch/left_tree.jsp"  allowTransparency="true"></IFRAME>
										</div>
		...
		<td class="ali01 ver01"  width="100%">
							<div id="rbox">
								...
								<div id="rbox_middleright">
									<div id="bs_right">
									       <IFRAME scrolling="auto" width="100%" height="99%" frameBorder=0 id=allstaffright name=allstaffright src=""  allowTransparency="true"></IFRAME>
									</div>
								</div>
								</div>
								</div>
