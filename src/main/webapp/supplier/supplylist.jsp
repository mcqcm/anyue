...
//**************************************************************************************************************
            ...
            columnDefs: [
                {//列添加函数
                    ...
                    render: function (a, b, c, d) {
                        ...
                        {
                            func: [
                                 {"name": "修改", "fn": "mod(\'" + "supplier!modsupplier.action" + "\',\'" + c.id + "\',\'" + "修改供应商信息" + "\')", "type": "primary"},
                                 {"name": "删除", "fn": "del(\'" + "supplier!delsupplier.action" + "\',\'" + c.id + "\')", "type": "danger"}
                            ]
                        };
      ...
      //**************************************************************************************************************
        ...
        table.columns().eq( 0 ).each( function ( colIdx ) {//每一列查询事件响应
...
<div class="container" style="position: relative;  height:95%; width:100%;">
	...
	<a class="toggle-vis" data-column="1">供应商编号</a>&nbsp;
	<a class="toggle-vis" data-column="2">供应商名称</a>&nbsp;
	<a class="toggle-vis" data-column="3">供应商地址</a>&nbsp;
