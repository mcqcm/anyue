...
//**************************************************************************************************************
            ...
            columnDefs: [
                {//列添加函数
                    ...
                    render: function (a, b, c, d) {
                        ...
                        {
                            func: [
                                   {"name": "查看处理详情", "fn": "see(\'" + "rubbish!seeOnlyContent.action" + "\',\'" + c.id + "\',\'" + "查看处理详情" + "\')", "type": "primary"}
                            ]
                        };
            ...
            initComplete: function () {
                //$("#mytool").append('<button type="button" class="btn btn-default btn-sm" onclick="add(\'rubbishmanage/addrubbish.jsp\',\'发布结果公告\')">添加废物处理</button>');
            	datesearch();
            }
...
<div class="container" style="position: relative;  height:95%; width:100%;">
	...
	<a class="toggle-vis" data-column="3">废物处理简介</a>&nbsp;
