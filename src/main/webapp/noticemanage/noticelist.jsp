...
//**************************************************************************************************************
            ...
            columnDefs: [
                {//列添加函数
                    ...
                    render: function (a, b, c, d) {
                        ...
                        {
                            func: [
                                   {"name": "修改", "fn": "mod(\'" + "notice!mod.action" + "\',\'" + c.id + "\',\'" + "修改公告" + "\')", "type": "primary"},
                                   {"name": "查看详情", "fn": "seeBig(\'" + "notice!seeDetail.action" + "\',\'" + c.id + "\',\'" + "查看详情" + "\')", "type": "primary"},
                                   {"name": "删除", "fn": "del(\'" + "notice!del.action" + "\',\'" + c.id + "\')", "type": "danger"}
                            ]
                        };
            ...
            initComplete: function () {
                $("#mytool").append('<button type="button" class="btn btn-default btn-sm" onclick="add(\'noticemanage/addnotice.jsp\',\'发布公告\')">发布公告</button>');
                datesearch();
            }
...
<div class="container" style="position: relative;  height:95%; width:100%;">
	...
	<a class="toggle-vis" data-column="2">发布人id</a>&nbsp;
	<a class="toggle-vis" data-column="3">发布人</a>&nbsp;
	<a class="toggle-vis" data-column="4">发布时间</a>&nbsp;
