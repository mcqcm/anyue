...
//**************************************************************************************************************
                    "entity": "OrgStaff",//必填
                    "condition": "t.organize.orgcode="+"'<%=orgcode%>'",  //第一次列出来数据的条件
            ...
            columnDefs: [
                {//列添加函数
                    ...
                    render: function (a, b, c, d) {
                        ...
                        {
                            func: [
                                 {"name": "修改", "fn": "mod(\'" + "orgstaff!modstaff.action" + "\',\'" + c.staffcode + "\',\'" + "修改员工信息" + "\')", "type": "primary"},
                                 {"name": "删除", "fn": "del(\'" + "orgstaff!delstaff.action" + "\',\'" + c.staffcode + "\')", "type": "danger"}
                            ]
                        };
            ...
            initComplete: function () {
                $("#mytool").append('<button type="button" class="btn btn-default btn-sm" onclick="add(\'orgstaff/addstaff.jsp?orgcode=<%=orgcode%>\',\'添加员工信息\')">添加员工信息</button>');
...
<div class="container" style="position: relative;  height:95%; width:100%;">
	<div align="left" >
	<a align="left">列隐藏：</a>&nbsp;
	<a class="toggle-vis" data-column="0">员工编号</a>&nbsp;
	...
	<a class="toggle-vis" data-column="5">地址</a>&nbsp;
