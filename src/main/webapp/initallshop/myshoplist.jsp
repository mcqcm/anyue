...
String belongcode=((SystemUser)request.getSession().getAttribute("loginuser")).getOrgcode();
%>
<head>
...
function uplicence(orgcode,title){
	...
	diag.Width=500;
	diag.Height=400;
	diag.URL = "/anyue/initallshop/uplicence2.jsp?orgcode="+orgcode;
...
//**************************************************************************************************************
            ...
            columnDefs: [
                {//列添加函数
                    ...
                    render: function (a, b, c, d) {
                        ...
                        {
                            func: [
                                 {"name": "修改", "fn": "mod(\'" + "initmyshops!modorg.action" + "\',\'" + c.orgcode + "\',\'" + "修改餐饮单位信息" + "\')", "type": "primary"},
                                 {"name": "上传许可证", "fn": "uplicence(\'" + c.orgcode + "\',\'" + "上传许可证" + "\')", "type": "primary"},
                                 {"name": "删除", "fn": "del(\'" + "initmyshops!delorg.action" + "\',\'" + c.orgcode + "\')", "type": "danger"},
            ...
            initComplete: function () {
                $("#mytool").append('<button type="button" class="btn btn-default btn-sm" onclick="add(\'initallshop/addmyshops.jsp?belongcode=<%=belongcode%>\',\'添加辖区餐饮单位\')">添加辖区餐饮单位</button>');
