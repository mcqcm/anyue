...
<body>
<form name="form1" id="form1" action="initmyshops!addorg.action" target="myshopsmanage" method="post">
		<table class="tableStyle" transMode="true">
		<tr>
			<td>单位编码：</td>
			<td><input type="text" name="orgInfo.orgcode"/>
			</td>
		</tr>
		<tr>
			<td>单位名称：</td><td><input type="text" name="orgInfo.orgname"/>
			</td>
		</tr>
		<tr>
			<td>地址：</td><td><input type="text" name="orgInfo.orglocation"/>
			</td>
		</tr>
		<tr>
			<td>负责人：</td><td><input type="text" name="orgInfo.chairman"/></td>
		</tr>
		<tr>
			<td>联系方式：</td><td><input type="text" name="orgInfo.callnum" /></td>
		</tr>
		<tr>
			<td>邮箱地址：</td><td><input type="text" name="orgInfo.email" /></td>
		</tr>
		<tr>
			<td>开业日期：</td><td><input type="text" class="Wdate" name="orgInfo.runtime" onfocus="new WdatePicker({lang:'zh-cn'})" value="<%=date%>" size="15"/></td>
		</tr>
		<tr>
			<td>餐饮类型：</td>			
		...
		<tr hidden="true">
			<td><input type="text" name="orgInfo.orgtype" value="餐饮单位"/></td><td><input type="text" name="orgInfo.belongcode" value="<%=belongcode%>"/></td>
		</tr>
		<tr>
			<td colspan="2">
