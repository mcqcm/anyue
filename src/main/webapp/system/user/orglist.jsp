...
//                 $("#mytool").append('<button type="button" class="btn btn-default btn-sm" onclick="add(\'user!findrole.action\',\'添加用户\')">添加用户</button>');
        ...
        $('#example tbody').on('click', 'tr', function () {
            var name = $('td', this).eq(0).text()+"&"+$('td', this).eq(1).text();
...
<div class="container" style="position: relative;  height:95%; width:100%;">
	<div align="left" >
	<a align="left">列隐藏：</a>&nbsp;
	<a class="toggle-vis" data-column="0">单位编码</a>&nbsp;
	<a class="toggle-vis" data-column="1">单位名称</a>&nbsp;
	<a class="toggle-vis" data-column="2">负责人</a>&nbsp;
	<a class="toggle-vis" data-column="3">地址</a>&nbsp;
	<a class="toggle-vis" data-column="4">单位类型</a>&nbsp;
	</div>
