...
//**************************************************************************************************************
                    "entity": "Organize",//必填
                    "condition": "t.parentcode="+"'<%=parentorgcode%>'",  //第一次列出来数据的条件
            ...
            columnDefs: [
                {//列添加函数
                    ...
                    render: function (a, b, c, d) {
                        ...
                        {
                            func: [
                                 {"name": "修改", "fn": "mod(\'" + "organize!modorg.action" + "\',\'" + c.orgcode + "\',\'" + "修改单位信息" + "\')", "type": "primary"},
                                 {"name": "删除", "fn": "del(\'" + "organize!delorg.action" + "\',\'" + c.orgcode + "\')", "type": "danger"}
                            ]
                        };
            ...
            initComplete: function () {
                $("#mytool").append('<button type="button" class="btn btn-default btn-sm" onclick="add(\'orgmanage/addorg.jsp?parentcode=<%=parentorgcode%>\',\'添加本层单位\')">添加本层单位</button>');
...
<div class="container" style="position: relative;  height:95%; width:100%;">
	<div align="left" >
	<a align="left">列隐藏：</a>&nbsp;
	<a class="toggle-vis" data-column="0">监管单位编码</a>&nbsp;
	<a class="toggle-vis" data-column="1">监管单位名称</a>&nbsp;
	<a class="toggle-vis" data-column="2">地址</a>&nbsp;
	<a class="toggle-vis" data-column="3">负责人</a>&nbsp;
	<a class="toggle-vis" data-column="4">联系方式</a>&nbsp;
	<a class="toggle-vis" data-column="5">辖区</a>&nbsp;
	<a class="toggle-vis" data-column="6">创建时间</a>&nbsp;
	<a class="toggle-vis" data-column="7">操作</a>&nbsp;
	</div>
