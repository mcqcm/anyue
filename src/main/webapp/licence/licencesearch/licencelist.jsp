            ...
            columnDefs: [
                {//列添加函数
                    ...
                    render: function (a, b, c, d) {
                        ...
                        {
                            func: [
                                 {"name": "查看许可证", "fn": "see(\'" + "applylicence!seelicence.action" + "\',\'" + c.id + "\',\'" + "查看许可证" + "\')", "type": "primary"}
                            ]
                        };
...
<div class="container" style="position: relative;  height:95%; width:100%;">
	...
	<a class="toggle-vis" data-column="1">生效时间</a>&nbsp;
	<a class="toggle-vis" data-column="2">失效时间</a>&nbsp;
	<a class="toggle-vis" data-column="3">是否有效</a>&nbsp;
