...
//**************************************************************************************************************
            ...
            columnDefs: [
                {//列添加函数
                    ...
                    render: function (a, b, c, d) {
                        ...
                        {
                            func: [
                                 {"name": "查看健康证", "fn": "see(\'" + "staffsearch!seehealthcard.action" + "\',\'" + c.staffcode + "\',\'" + "查看健康证" + "\')", "type": "primary"},
                            ]
                        };
        ...
        $('#button').click( function () {
        	...
        	for(;i<table.rows('.selected').data().length;i++){
        		staffcodes=staffcodes+table.rows('.selected').data()[i].staffcode+";";
        	}
        	add('stafftrain!getstaffs.action?staffcodes='+staffcodes,'上报培训员工');
           // alert(staffcodes);
        } );
//**************************************************************************************************************
