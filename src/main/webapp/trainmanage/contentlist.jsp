...
//**************************************************************************************************************
            ...
            columnDefs: [
                {//列添加函数
                    ...
                    render: function (a, b, c, d) {
                        ...
                        {
                            func: [
                                   {"name": "修改", "fn": "mod(\'" + "trainmanage!contentmodprepare.action" + "\',\'" + c.id + "\',\'" + "修改培训内容 " + "\')", "type": "primary"},
                                   {"name": "删除", "fn": "del(\'" + "trainmanage!contentdel.action" + "\',\'" + c.id + "\')", "type": "danger"},
                                   {"name": "停止人员上报", "fn": "changestatus(\'" + "trainmanage!endstaffup.action" + "\',\'" + c.id + "\')", "type": "danger"},
                                   {"name": "已通知的单位", "fn": "seeorg(\'" + "trainmanage!gethavesendorg.action?contentid=" +c.id+ "\',\'" + "已通知的餐饮单位 " + "\')", "type": "primary"},
                                   {"name": "参加员工", "fn": "seeorg(\'" + "stafftrain!seeAttendee.action?contentid=" +c.id+ "\',\'" + "参加员工" + "\')", "type": "primary"}
                            ]
                        };
            ...
            initComplete: function () {
                $("#mytool").append('<button type="button" class="btn btn-default btn-sm" onclick="add(\'trainmanage/addcontent.jsp\',\'添加培训通知\')">添加培训通知</button>');
                datesearch();
            }
...
<div class="container" style="position: relative;  height:95%; width:100%;">
	...
	<a class="toggle-vis" data-column="2">发布时间</a>&nbsp;
	<a class="toggle-vis" data-column="3">是否已停止上报</a>&nbsp;
	<a class="toggle-vis" data-column="4">操作</a>&nbsp;
	</div>
